	...
	<div class="container">
		...
		<div class="form-card">
			...
			<div class="form-title">
				...
				<h2>
					<i class="fa-solid fa-bullhorn"></i> Publish New Notice
				</h2>

				<p>Create and publish notices for all tenants</p>
			...
			<form action="add-notice" method="post">
				...
				<div class="form-group">
					...
					</label> <input type="text" name="title" placeholder="Enter Notice Title"
						required>
				...
				<div class="form-group">
					...
					<textarea name="description"
						placeholder="Enter complete notice details..." required></textarea>
				...
				<div class="form-group">
					...
					<label> <i class="fa-solid fa-calendar-days"></i> Notice
						Date
					</label> <input type="date" name="noticeDate" required>
			...
			<div class="action-links">
				...
				<a href="fetch-notices" class="notice-btn"> <i
					class="fa-solid fa-list"></i> View Notices
			...
			<div class="info-box">
				...
				<i class="fa-solid fa-circle-info"></i> New notices will be visible
				immediately to all tenants.
