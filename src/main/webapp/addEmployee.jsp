	...
	<div class="container">
		...
		<div class="form-card">
			...
			<form action="add-employee" method="post">
				...
				<div class="form-grid">
					...
					<div class="form-group">
						...
						<label>Monthly Salary (₹)</label> <input type="number"
					...
					<div class="form-group">
						...
						<label>Status</label> <input type="text" name="status"
							value="Active" class="readonly" readonly>
			...
			<div class="info">
				...
				<i class="fa-solid fa-circle-info"></i> New employees will be added
				to the staff management records immediately.
