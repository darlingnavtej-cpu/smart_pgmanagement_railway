...
<body>
		...
		<div class="form-card">
			...
			<div class="form-title">
				...
				<h2>
					...
					<i class="fa-solid fa-bed"></i> Add New Room

				</h2>

				<p>Create and manage room information</p>
			...
			<form action="add-room" method="post">
				...
				<div class="form-grid">
					...
					<div class="form-group">
						...
						<label>Occupied Beds</label> <input type="number" name="occupied"
							value="0" required>
					...
					<div class="form-group">
						...
						<label>Monthly Rent (₹)</label> <input type="number" name="rent"
							required>
			...
			<div class="info">
				...
				<i class="fa-solid fa-circle-info"></i> New rooms added here will be
	...
	<script>
		document.addEventListener("DOMContentLoaded", function() {
			...
			const occupied = document.querySelector('input[name="occupied"]');
