...
try {
	...
	pstmt = con.prepareStatement("SELECT * FROM fee WHERE tenant_id=? ORDER BY fee_id DESC");
...
<title>Tenant Rent Status</title>
...
<body>
	...
	<div class="container">
		...
		<div class="card">
			...
			<div class="page-title">
				<h2>
					<i class="fa-solid fa-wallet"></i> My Rent Details
				</h2>
				<p>View your monthly rent payment status and history</p>
			</div>
			...
			<div class="table-wrapper">
				<table>
					...
					<tr>
						<td colspan="4" class="empty-row">No Rent Data Available</td>
					</tr>
 ...
 %>
					...
					<tr>
						<td colspan="4" class="empty-row">No Rent Records Found</td>
					</tr>
