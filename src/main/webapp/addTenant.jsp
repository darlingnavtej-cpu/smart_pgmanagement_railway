			...
			<form action="add-tenant" method="post"
				...
				<div class="form-grid">
					...
					<div class="form-group">
						<label>Tenant ID</label> <input type="text" placeholder="Auto-generated by system" disabled style="background-color: #f1f5f9; color: #94a3b8; border-color: #cbd5e1; cursor: not-allowed;">
					</div>
